...
class TestUrls(SimpleTestCase):
    ...
    def test_user_add_review_url(self):
        url = reverse("user_add_review")
        self.assertEqual(resolve(url).func.view_class.__name__, "PostReviewView")

    def test_user_del_review_url(self):
        url = reverse("user_del_review")
